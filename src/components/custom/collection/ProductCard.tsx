...
export default function ProductCard({
  ...
  return (
    ...
    >
      <span className="bg-slate-50 absolute top-1 left-1 lg:top-5 lg:left-5 block w-fit px-4 py-1 border border-slate-600 rounded-lg text-sm font-heading text-slate-600/90">
        New
      </span>
      <Image
